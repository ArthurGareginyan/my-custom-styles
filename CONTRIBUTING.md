...
When contributing to "My Custom Styles" you have to follow some conventions and a simple workflow. It allows me to handle the requests quickly and ensure best quality
for the "My Custom Styles" core code.
...
The preferred way to report bugs is to use the [GitHub issue tracker](https://github.com/ArthurGareginyan/my-custom-styles/issues). Before reporting a bug, read these pointers.
...
- "My Custom Styles" is maintained by me. I don't owe you anything, so be polite. Reports with an indignant or belligerent tone tend to be moved to the bottom of the pile.
...
- Mention which release of "My Custom Styles" you're using.
...
- Fork [My Custom Styles](https://github.com/ArthurGareginyan/my-custom-styles)
...
By contributing code to "My Custom Styles" you:
