 ...
 * @since 4.0.1
 */
function mcstyles_plugin_version_number() {
    ...
    if ( $new_number == $current_number ) {
        ...
        if ( $info['old_version'] == '1' ) {
            ...
            $info['old_version'] = '0';
            update_option( 'mcstyles_service_info', $info );
...
mcstyles_plugin_version_number();
