 ...
 */
function spacexchimp_p003_load_scripts_codemirror( $prefix, $url, $version ) {
 ...
 */
function spacexchimp_p003_load_scripts_admin( $hook ) {
    ...
    spacexchimp_p003_load_scripts_codemirror( $prefix, $url, $version );

}
add_action( 'admin_enqueue_scripts', 'spacexchimp_p003_load_scripts_admin' );
