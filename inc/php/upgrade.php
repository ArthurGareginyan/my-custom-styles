 ...
 */
function spacexchimp_p003_upgrade_4_7() {

    // Upgrade number
    $upgrade_number_new = '0001';
    $prefix_old = 'mcstyles';
    $prefix_new = 'spacexchimp_p003';
    ...
    $snippets_old = !empty( $settings_current['mcstyles-content'] ) ? $settings_current['mcstyles-content'] : '';
