 ...
 */
function spacexchimp_p003_render_submenu_page() {
    ...
    // Call messages
    spacexchimp_p003_hello_message();
    spacexchimp_p003_error_message();
    spacexchimp_p003_successfull_message();
    ...
    <div class="wrap">
        ...
        <div id="poststuff" class="metabox-holder has-right-sidebar">
            ...
            <div class="tab-page fade active in" id="tab-core">
                <!-- INCLUDE SIDEBAR -->
                <?php require_once( SPACEXCHIMP_P003_PATH . 'inc/php/sidebar.php' ); ?>
                <!-- INCLUDE SETTINGS -->
                <?php require_once( SPACEXCHIMP_P003_PATH . 'inc/php/settings.php' ); ?>
            </div>
            <!-- END-TAB 1 -->
            ...
            <div class="tab-page fade" id="tab-faq">
                <div class="postbox">
                    ...
                    <div class="inside">
                        ...
                        <div class="answer-<?php echo $i; $i++ ?>">
                            <?php _e( 'On the "Main" tab, place your custom CSS code in the code editor field, switch the toggle to the "ON" position and click the "Save changes" button.', $text ); ?>
                            <?php _e( 'Enjoy the result of applying your custom CSS code.', $text ); ?>
                            <?php _e( 'It\'s that simple!', $text ); ?>
                        </div>

                        <div class="question-<?php echo $i; ?>">
                            <?php _e( 'How much of CSS code (characters) I can enter in the code editor?', $text ); ?>
                        </div>
                        <div class="answer-<?php echo $i; $i++ ?>">
                        ...
                        <div class="question-<?php echo $i; ?>">
                            <?php _e( 'Can I add my custom CSS code to a specific page of my website?', $text ); ?>
                        </div>
                        <div class="answer-<?php echo $i; $i++ ?>">
                            <?php _e( 'For now, this plugin does not have an option to apply the custom CSS code only on specific pages.', $text ); ?>
                            <?php _e( 'We plan to add this feature soon.', $text ); ?>
                            <?php _e( 'But for now in order to apply your custom CSS code only on specific pages of your website, you need to wrap your custom CSS code in a PHP code that will determine the page you want.', $text ); ?>
...
add_action( 'wp_head', 'my_custom_css_code' );</code></pre>
                        ...
                        <div class="question-<?php echo $i; ?> question-red">
                            <?php _e( 'My custom CSS code is not working.', $text ); ?>
                            <?php _e( 'What could be wrong?', $text ); ?>
                        </div>
                        <div class="answer-<?php echo $i; $i++ ?>">
                            <?php _e( 'It happens that your custom CSS code that you insert on the plugin page does not work, even if an error message does not appear.', $text ); ?>
                            <?php _e( 'Here are a few of the most likely causes of the issue:', $text ); ?>
                            <ol class="custom-list">
                                <li><?php _e( 'You have a typo during the insertion of your custom CSS code.', $text ); ?></li>
                                <li><?php _e( 'Your custom CSS code has a syntax error.', $text ); ?></li>
                                <li><?php _e( 'Your custom CSS code is incorrect and may not work.', $text ); ?></li>
                            </ol>
                        </div>
                ...
                <div class="postbox">
                    ...
                    <div class="inside">
                        <span class="image-with-button pull-left">
                            <img src="<?php echo SPACEXCHIMP_P003_URL . 'inc/img/thanks.png'; ?>" alt="Thanks!">
                            <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=8A88KC7TFF6CS" target="_blank" class="btn btn-default button-labeled">
                                <span class="btn-label">
                                    <img src="<?php echo SPACEXCHIMP_P003_URL . 'inc/img/paypal.svg'; ?>" alt="PayPal">
                                </span>
