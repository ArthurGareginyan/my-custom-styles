...
add_action( 'wp_head', 'my_custom_css_code' );</code></pre>
                        ...
                        <div class="question-8 question-red"><?php _e( 'My custom CSS code is not working. What could be wrong?', $text ); ?></div>
                        <div class="answer-8"><?php _e( 'It happens that your custom CSS code that you insert on the plugin page does not work, even if an error message does not appear. Here are a few of the most likely causes of the issue:', $text ); ?>
                                               <ol class="custom-counter">
