            ...
            <div class="meta-box-sortabless">
                ...
                <div class="postbox">
                    ...
                    <div class="inside">
                        ...
                        <div class="answer-<?php echo $i; $i++ ?>">
                            <?php _e( 'On the "Main" tab, place your custom CSS code in the code editor field, switch the toggle to the "ON" position and click the "Save changes" button.', $plugin['text'] ); ?>
                            <?php _e( 'Enjoy the result of applying your custom CSS code.', $plugin['text'] ); ?>
                            <?php _e( 'It\'s that simple!', $plugin['text'] ); ?>
                        </div>

                        <div class="question-<?php echo $i; ?>">
                            <?php _e( 'How much of CSS code (characters) I can enter in the code editor?', $plugin['text'] ); ?>
                        </div>
                        <div class="answer-<?php echo $i; $i++ ?>">
                        ...
                        <div class="question-<?php echo $i; ?>">
                            <?php _e( 'Can I add my custom CSS code to a specific page of my website?', $plugin['text'] ); ?>
                        </div>
                        <div class="answer-<?php echo $i; $i++ ?>">
                            <?php _e( 'For now, this plugin does not have an option to apply the custom CSS code only on specific pages.', $plugin['text'] ); ?>
                            <?php _e( 'We plan to add this feature soon.', $plugin['text'] ); ?>
                            <?php _e( 'But for now in order to apply your custom CSS code only on specific pages of your website, you need to wrap your custom CSS code in a PHP code that will determine the page you want.', $plugin['text'] ); ?>
...
add_action( 'wp_head', 'my_custom_css_code' );</code></pre>
                        ...
                        <div class="question-<?php echo $i; ?> question-red">
                            <?php _e( 'My custom CSS code is not working.', $plugin['text'] ); ?>
                            <?php _e( 'What could be wrong?', $plugin['text'] ); ?>
                        </div>
                        <div class="answer-<?php echo $i; $i++ ?>">
                            <?php _e( 'It happens that your custom CSS code that you insert on the plugin page does not work, even if an error message does not appear.', $plugin['text'] ); ?>
                            <?php _e( 'Here are a few of the most likely causes of the issue:', $plugin['text'] ); ?>
                            <ol class="custom-list">
                                <li><?php _e( 'You have a typo during the insertion of your custom CSS code.', $plugin['text'] ); ?></li>
                                <li><?php _e( 'Your custom CSS code has a syntax error.', $plugin['text'] ); ?></li>
                                <li><?php _e( 'Your custom CSS code is incorrect and may not work.', $plugin['text'] ); ?></li>
                            </ol>
                        </div>
