    ...
    <div class="inner-sidebar">
        <div id="side-sortables" class="meta-box-sortabless ui-sortable">
            ...
            <div class="postbox about">
                ...
                <div class="inside">
                    <p><?php _e( 'This plugin gives you the ability to easily and safely add your custom CSS code to your WordPress website, directly out of the WordPress Admin Area, without the need to have an external editor.', $plugin['text'] ); ?></p>
                </div>
            </div>
            <!-- END ABOUT -->
