...
defined('MCSTYLES_VERSION') or define('MCSTYLES_VERSION', '3.3');
...
function mcstyles_settings_link( $links ) {
	$settings_page = '<a href="' . admin_url( 'themes.php?page=my-custom-styles.php' ) .'">' . __( 'Settings', MCSTYLES_TEXT ) . '</a>';
...
function mcstyles_register_submenu_page() {
	add_theme_page( __( 'My Custom Styles', MCSTYLES_TEXT ), __( 'Custom Styles', MCSTYLES_TEXT ), 'edit_theme_options', basename( __FILE__ ), 'mcstyles_render_submenu_page' );
}
